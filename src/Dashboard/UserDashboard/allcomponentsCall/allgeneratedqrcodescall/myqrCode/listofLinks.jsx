...
const ListofLinksDataList = () => {
  ...
  const handleEditClick = (id) => {
    ...
    if (selectedBusiness) {
      ...
      localStorage.setItem('url', '/dashboard/generate/listoflinks?edit')


      setTimeout(() => {
        navigate("/dashboard/generate/listoflinks?edit");
      }, 3000);
    } else {
          ...
          <div key={business._id} className="business-item">
            <div className="small-row-container-for-qr-code-display">
              ...
              <div className="action-btns-for-qr-active-del-edit">
                ...
                <button className="btn-18" onClick={() => handleDeleteClick('listoflinks', business._id)}>
                  <span> Delete</span>
                </button>
...
export default ListofLinksDataList;
