            ...
            <div className="small-row-container-for-qr-code-display">
              ...
              <h3>{index + 1}.</h3> 
                <div className="qr-code-display-container">
                  ...
                  >
                    <QRCode
                      value={`${process.env.REACT_APP_FRONTEND_URL}/display/qr-product/${business._id}`}
              ...
              <div className="action-btns-for-qr-active-del-edit">
                ...
                <button className="btn-18" onClick={() => handleDeleteClick('product', business._id)}>
                  <span> Delete</span>
                </button>
